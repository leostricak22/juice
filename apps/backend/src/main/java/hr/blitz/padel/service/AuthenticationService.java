package hr.blitz.padel.service;

import hr.blitz.padel.domain.exception.AppException;
import hr.blitz.padel.domain.model.User;
import hr.blitz.padel.repository.UserRepository;
...
import static hr.blitz.padel.domain.exception.ErrorCode.CONFLICT;
import static hr.blitz.padel.domain.exception.ErrorCode.UNAUTHORIZED;
